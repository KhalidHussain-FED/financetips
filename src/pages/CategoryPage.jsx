...
const CATEGORY_DESC = {
  Accounting: 'Financial statements, reconciliations, chart of accounts, and reporting basics for US small businesses.',
  Payroll: 'Processing payroll, W-2s, 1099s, IRS compliance, and employee pay guides for US employers.',
  Taxes: 'IRS tax planning, quarterly estimates, deductions, self-employment taxes, and filing strategies.',
  Bookkeeping: 'Record-keeping systems, ledgers, receipts, and keeping your books clean year-round.',
  'Financial Planning': 'Budgeting, cash flow management, and long-term financial health for your business.',
};
